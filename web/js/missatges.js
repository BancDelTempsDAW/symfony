       ...
       $.post(url,{
           ...
           var output = '<div class="llista-missatges list-group">';
            ...
            if(data.responseCode==200 ){    
                ...
                $('#outputButton_'+id).html("<div><a id='nou_miss_"+id+"' class='btn btn-default' href='/symfony/web/app_dev.php/user/solicituts/enviades2/"+id+"' ><span class='glyphicon glyphicon-pencil'></span> Nou Missatge</a></div>");
            }
