...
use bonavall\BancdeltempsBundle\Form\PersonaType;
...
class PersonaController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $entities = $em->getRepository('bonavallBancdeltempsBundle:Persona')->findAll();
     ...
     * @Method("POST")
     * @Template("bonavallBancdeltempsBundle:Persona:new.html.twig")
     */
    ...
    */
    ...
    public function showAction($id)
    {
        ...
        $entity = $em->getRepository('bonavallBancdeltempsBundle:Persona')->find($id);
    ...
    */
     ...
     * @Method("PUT")
     * @Template("bonavallBancdeltempsBundle:Persona:edit.html.twig")
     */
